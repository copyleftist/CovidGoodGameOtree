# Generated by Django 2.2.12 on 2021-02-19 16:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='public_covid_group', to='otree.Session')),
            ],
            options={
                'db_table': 'public_covid_group',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round_number', otree.db.models.PositiveIntegerField(db_index=True, null=True)),
                ('session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='public_covid_subsession', to='otree.Session')),
            ],
            options={
                'db_table': 'public_covid_subsession',
            },
